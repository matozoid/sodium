...
class PumpFace extends Component {
    ...
    PumpFace(
        ...
        background = ImageIO.read(getClass().getResourceAsStream("/images/petrol-pump-front.png"));
        for (int i = 0; i < 8; i++) {
            smalls[i] = ImageIO.read(getClass().getResourceAsStream("/images/small" + i + ".png"));
            larges[i] = ImageIO.read(getClass().getResourceAsStream("/images/large" + i + ".png"));
        }
        for (int i = 0; i < 3; i++) {
            nozzleImgs[i] = ImageIO.read(getClass().getResourceAsStream("/images/nozzle" + (i + 1) + ".png"));
